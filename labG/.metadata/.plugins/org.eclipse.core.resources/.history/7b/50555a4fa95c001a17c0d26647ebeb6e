...
#define FRO_SECOND_FREQ 12000000
#define IVALUE_CH0 (FRO_SECOND_FREQ * 24)		// [counts] value FRO_Freq * (IRQ desired period)
#define IVALUE_CH1 (1200000)		// [counts] value FRO_Freq * (IRQ desired period)
